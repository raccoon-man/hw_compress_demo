...
- #### city0-4G-1M-16777234
- CSV 文件大小: 814752 字节
- Parquet 文件大小: 269916 字节
- Parquet压缩率: 0.33128608459997644
- 压缩后 Parquet 文件大小: 153941 字节
- 字典json大小: 7772字节
- xz压缩后字典json大小: 3012字节
- json 和 parquet 一起的压缩率: 0.1926389870782766
- 最终压缩数据和原parquet压缩率之差: 0.13864709752169985
...
- compress.py是压缩代码，程序主入口，segment.py是切分大整数的代码

- decompress.py是解压缩程序入口，unprocess.py说明：此文档为解压缩文档，是根据exact.py压缩的完全解压缩，所用数据和格式对照全部严格按照exact.py的压缩流程。
...
- city0-4G-1M-decompress.csv（自命名的）为解压缩后生成的文件
